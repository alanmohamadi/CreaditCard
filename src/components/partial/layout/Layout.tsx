            ...
            <header className="h-10  text-white bg-black flex items-center justify-between px-7 z-10">
                ...
                <div className="flex gap-1 items-center justify-center">
                    <svg width="78" height="13" viewBox="0 0 78 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path opacity="0.4" d="M76 5V9.22034C76.8491 8.86291 77.4012 8.0314 77.4012 7.11017C77.4012 6.18894 76.8491 5.35744 76 5Z" fill="#EAEAEA" />
                        <path d="M52 4C52 2.89543 52.8954 2 54 2H71C72.1046 2 73 2.89543 73 4V9C73 10.1046 72.1046 11 71 11H54C52.8954 11 52 10.1046 52 9V4Z" fill="#EAEAEA" />
